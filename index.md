...
latlng: "52.379596, 13.062290"       # decimal latitude and longitude of workshop venue (e.g., "41.7901128,-87.6007318" - use http://www.latlong.net/)
...
instructor: ["Frank Hellmann (PIK)", "Sebastian Heimann (GFZ)", "Robert Gieseke (PIK)", "Joachim Krois (Charité)", "Stefan Lüdtke (GFZ)", "Peter Evans (GFZ)", "Knut Günther (GFZ)", "Martin Hammitzsch (GFZ)"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Berry Boessenkool (UP)", "Michel Wortmann (PIK)", "Daniel Beiter (GFZ)", "Daniel Kreyling (AWI)", "..."]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
collaborative_notes: [http://pad.software-carpentry.org/2018-02-22-Potsdam-Berlin]            # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
