...
instructor: ["Frank Hellmann (PIK)", "Sebastian Heimann (GFZ)", "Robert Gieseke (PIK)", "Joachim Krois (Charité)", "Stefan Lüdtke (GFZ)", "Peter Evans (GFZ)", "Knut Günther (GFZ)", "Martin Hammitzsch (GFZ)", "Marvin Reich (GFZ)", "Benoit Bovy (GFZ)", "Marius Isken (GFZ)"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Berry Boessenkool (UP)", "Michel Wortmann (PIK)", "Daniel Beiter (GFZ)", "Daniel Kreyling (AWI)", "Katrin Leinweber (TIB)", "..."]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
